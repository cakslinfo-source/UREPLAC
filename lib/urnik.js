...
// Vikend dopoldne: dodatna pomoč.
export const SMENA_POMOC = {
  key: 'h',
  label: 'Pomoč',
  kratko: 'POM',
  start: '09:00',
...
// Petek: odprto do 23h.
const PETEK = spremeni(PRIVZETE_SMENE, { z: { end: '23:00' } });
// Sobota: do 23h + dopoldanska pomoč.
const SOBOTA = [...PETEK, { ...SMENA_POMOC }];
// Nedelja: odpiranje ob 7h + dopoldanska pomoč.
const NEDELJA = [
  ...spremeni(PRIVZETE_SMENE, {
    o: { start: '07:00', end: '14:00' },
    d: { start: '08:00', end: '15:00' },
  }),
  { ...SMENA_POMOC, start: '10:00', end: '15:00' },
];
